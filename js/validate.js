$(document).ready(() => {
  $("#button").on("click", () => {
    ...
    // this code mean get the value from input
    ...
    // do the condition that if it true and flase
    // Update error list
    updateHtmlErrorMessage(errors);
    // this code mean get the value when it error
  });
});
